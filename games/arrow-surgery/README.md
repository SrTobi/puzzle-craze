...
Run these commands from the repository root. Open `/games/arrow-surgery/` to play, or `/` for the game collection. Paths below are relative to this game directory. See the [root guide](../../README.md) for shared infrastructure and deployment.
